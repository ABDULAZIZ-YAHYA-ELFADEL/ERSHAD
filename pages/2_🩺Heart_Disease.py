...
#------------------------------------------------------------------------------
tab3.markdown('### :red[🚩 This test requires an ECG examination. ]')
tab3.write("\n")
with tab3.form('form'):
    ...
    with col3:
        ...
        #--------------------------------------------------------------------
        bt7=st.text_input('Cholesterol?')
        #--------------------------------------------------------------------
        bt6=st.text_input('Resting blood perssure?')
        #--------------------------------------------------------------------
        bt9=st.text_input('Maximum heart rate?')
        #--------------------------------------------------------------------
